...
# Let user decide to a) create user or b) login.  In case of a, add username/salted password to dictionary.
# In case of b, check username/salted password against dictionary, success if exists, else fail.
